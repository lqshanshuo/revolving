 ...
 */
@Entity
@Table(name = "genericentity", catalog = "revolving", schema = "public")
@XmlRootElement
@NamedQueries({
...
public class Genericentity implements Serializable {
    ...
    private Collection<Genericentity> genericentityCollection;
    @JoinColumn(name = "parentid", referencedColumnName = "id")
    @ManyToOne
    private Genericentity parentid;
    ...
    @XmlTransient
    @JsonIgnore
    public Collection<Genericentity> getGenericentityCollection() {
        return genericentityCollection;
    }

    public void setGenericentityCollection(Collection<Genericentity> genericentityCollection) {
        this.genericentityCollection = genericentityCollection;
    }

    public Genericentity getParentid() {
        return parentid;
    }

    public void setParentid(Genericentity parentid) {
    ...
    public String toString() {
        return "revolvinglamp.entity.Genericentity[ id=" + id + " ]";
    }
